...
Excel.prototype.getData = function(fullFile, listType) {
    return new Promise((resolve, reject) => {
        try{
            ...
            var finalData = (listType == "A")? createListTypeA(data) : createListTypeB(data);
            resolve(finalData);
        }catch(err){
            reject(err);
        }
